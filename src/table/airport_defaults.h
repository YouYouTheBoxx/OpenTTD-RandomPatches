...
/** Tiles for International Airport (large) - 2 runways */
static const AirportTileTable _tile_table_terminus4_0[] = {
	MK(0, 0, APT_RADAR_FENCE_NE),
	MK(1, 0, APT_RUNWAY_END_FENCE_NE_NW),
	MK(2, 0, APT_RUNWAY_FENCE_NW),
	MK(3, 0, APT_RUNWAY_FENCE_NW),
	...
	MK(7, 10, APT_RUNWAY_END_FENCE_SE_SW),
	MK(8, 10, APT_EMPTY),
	MK(0, 11, APT_RADAR_FENCE_NE),
	MK(1, 11, APT_RUNWAY_END_FENCE_NE_NW),
	MK(2, 11, APT_RUNWAY_FENCE_NW),
	MK(3, 11, APT_RUNWAY_FENCE_NW),
	MK(4, 11, APT_RUNWAY_FENCE_NW),
	MK(5, 11, APT_RUNWAY_FENCE_NW),
	MK(6, 11, APT_RUNWAY_FENCE_NW),
	MK(7, 11, APT_RUNWAY_FENCE_NW),
	MK(8, 11, APT_RUNWAY_END_FENCE_NW_SW),
	MK(0, 12, APT_RUNWAY_END_FENCE_NE_NW),
	MK(1, 12, APT_RUNWAY_2),
	MK(2, 12, APT_RUNWAY_2),
	MK(3, 12, APT_RUNWAY_2),
	MK(4, 12, APT_RUNWAY_2),
	MK(5, 12, APT_RUNWAY_2),
	MK(6, 12, APT_RUNWAY_2),
	MK(7, 12, APT_RUNWAY_END_FENCE_SE_SW),
	MK(8, 12, APT_APRON_FENCE_NE_SW),
	MK(0, 13, APT_APRON_FENCE_NE_SW),
	MK(1, 13, APT_EMPTY),
	MK(2, 13, APT_APRON_FENCE_NE),
	MK(3, 13, APT_APRON),
	MK(4, 13, APT_APRON),
	MK(5, 13, APT_APRON),
	MK(6, 13, APT_APRON),
	MK(7, 13, APT_RADIO_TOWER_FENCE_NE),
	MK(8, 13, APT_APRON_FENCE_NE_SW),
	MK(0, 14, APT_APRON_FENCE_NE),
	MK(1, 14, APT_APRON_HALF_EAST),
	MK(2, 14, APT_APRON_FENCE_NE),
	MK(3, 14, APT_TOWER),
	MK(4, 14, APT_HELIPAD_2),
	MK(5, 14, APT_HELIPAD_2),
	MK(6, 14, APT_APRON),
	MK(7, 14, APT_APRON_FENCE_NW),
	MK(8, 14, APT_APRON_FENCE_SW),
	MK(0, 15, APT_APRON_FENCE_NE),
	MK(1, 15, APT_APRON),
	MK(2, 15, APT_APRON),
	MK(3, 15, APT_STAND),
	MK(4, 15, APT_BUILDING_1),
	MK(5, 15, APT_STAND),
	MK(6, 15, APT_APRON),
	MK(7, 15, APT_LOW_BUILDING),
	MK(8, 15, APT_DEPOT_SE),
	MK(0, 16, APT_DEPOT_SE),
	MK(1, 16, APT_LOW_BUILDING),
	MK(2, 16, APT_APRON),
	MK(3, 16, APT_STAND),
	MK(4, 16, APT_BUILDING_2),
	MK(5, 16, APT_STAND),
	MK(6, 16, APT_APRON),
	MK(7, 16, APT_APRON),
	MK(8, 16, APT_APRON_FENCE_SW),
	MK(0, 17, APT_APRON_FENCE_NE),
	MK(1, 17, APT_APRON),
	MK(2, 17, APT_APRON),
	MK(3, 17, APT_STAND),
	MK(4, 17, APT_BUILDING_3),
	MK(5, 17, APT_STAND),
	MK(6, 17, APT_APRON),
	MK(7, 17, APT_APRON),
	MK(8, 17, APT_APRON_FENCE_SW),
	MK(0, 18, APT_APRON_FENCE_NE),
	MK(1, 18, APT_APRON_FENCE_SE),
	MK(2, 18, APT_APRON),
	MK(3, 18, APT_STAND),
	MK(4, 18, APT_ROUND_TERMINAL),
	MK(5, 18, APT_STAND),
	MK(6, 18, APT_APRON_FENCE_SW),
	MK(7, 18, APT_APRON_HALF_WEST),
	MK(8, 18, APT_APRON_FENCE_SW),
	MK(0, 19, APT_APRON_FENCE_NE),
	MK(1, 19, APT_GRASS_FENCE_NE_FLAG_2),
	MK(2, 19, APT_APRON_FENCE_NE),
	MK(3, 19, APT_APRON),
	MK(4, 19, APT_APRON),
	MK(5, 19, APT_APRON),
	MK(6, 19, APT_APRON_FENCE_SW),
	MK(7, 19, APT_EMPTY),
	MK(8, 19, APT_APRON_FENCE_NE_SW),
	MK(0, 20, APT_APRON_FENCE_NE),
	MK(1, 20, APT_RUNWAY_END_FENCE_NE_NW),
	MK(2, 20, APT_RUNWAY_FENCE_NW),
	MK(3, 20, APT_RUNWAY_FENCE_NW),
	MK(4, 20, APT_RUNWAY_FENCE_NW),
	MK(5, 20, APT_RUNWAY_FENCE_NW),
	MK(6, 20, APT_RUNWAY_FENCE_NW),
	MK(7, 20, APT_RUNWAY_FENCE_NW),
	MK(8, 20, APT_RUNWAY_END_FENCE_SE_SW),
	MK(0, 21, APT_RUNWAY_END_FENCE_NE_SE),
	MK(1, 21, APT_RUNWAY_2),
	MK(2, 21, APT_RUNWAY_2),
	MK(3, 21, APT_RUNWAY_2),
	MK(4, 21, APT_RUNWAY_2),
	MK(5, 21, APT_RUNWAY_2),
	MK(6, 21, APT_RUNWAY_2),
	MK(7, 21, APT_RUNWAY_END_FENCE_SE_SW),
	MK(8, 21, APT_EMPTY),
	MKEND
};

/* static const AirportTileTable * const _tile_table_terminus5[] = {
	_tile_table_terminus5_0,
}; */

static const AirportTileTable * const _tile_table_terminus4[] = {
	_tile_table_terminus4_0,
};
...
extern const AirportSpec _origin_airport_specs[] = {
	...
	//AS(terminus4,        9, 21,2010, MAX_YEAR, 10, 25, 72, ATP_TTDP_LARGE,    APC_HUB,      STR_AIRPORT_INTERCONTINENTAL, SPR_AIRPORT_PREVIEW_INTERCONTINENTAL),
